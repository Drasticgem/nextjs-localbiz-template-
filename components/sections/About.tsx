        ...
        <Reveal className="md:flex md:items-start md:gap-12">
          ...
          <div className="max-w-[520px] max-[768px]:max-w-none">
            ...
            <p className="mb-6 text-[14px] leading-[1.8] text-white/60">
              Founded by {BUSINESS.founder} in {BUSINESS.founded}, we&apos;ve built a
              strong reputation for quality workmanship, transparent communication, and
              on-time delivery. Update this section with your client&apos;s story, service
              area, and differentiators.
            </p>
            <a
              href="#"
